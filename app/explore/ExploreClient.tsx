    ...
    <div className="min-h-screen bg-[#070d10] text-white font-sans selection:bg-amber-500/30 overflow-x-hidden" dir="rtl">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? 'bg-[#050b0d]/95 backdrop-blur-md shadow-lg border-b border-white/5' : 'bg-gradient-to-b from-black/60 to-transparent'}`}>
        ...
        <div className={`container mx-auto px-4 sm:px-6 flex items-center overflow-hidden transition-all duration-500 ${isScrolled ? 'h-0 opacity-0' : 'h-8 opacity-100'}`}>
          <div className="flex items-center gap-3 sm:gap-5 text-[10px] sm:text-[11px] font-bold text-gray-200 leading-none">
            <button className="hover:text-amber-400 flex items-center gap-1.5 transition-colors leading-none">
              <span className="w-4 h-3 rounded-[2px] bg-blue-600 text-white text-[7px] flex items-center justify-center leading-none shrink-0">FR</span> Français
            </button>
            <button className="hover:text-amber-400 flex items-center gap-1.5 transition-colors leading-none">
              <span className="w-4 h-3 rounded-[2px] bg-red-700 text-white text-[7px] flex items-center justify-center leading-none shrink-0">EN</span> English
            </button>
            <button className="text-amber-400 flex items-center gap-1.5 transition-colors leading-none">
              <span className="w-4 h-3 rounded-[2px] bg-emerald-700 text-white text-[7px] flex items-center justify-center leading-none shrink-0">DZ</span> العربية
            </button>
          </div>
        </div>
      ...
      <section className="relative flex flex-col justify-center items-center pt-32 pb-16 sm:pt-40 sm:pb-20 min-h-[560px] sm:min-h-[640px] md:min-h-[720px]">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 flex flex-col items-center text-center max-w-4xl">
          <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-4 drop-shadow-2xl text-white leading-tight">اكتشف سحر ولاية الوادي</h2>
          <h3 className="text-base sm:text-xl md:text-2xl text-amber-400 font-bold mb-8">حيث تلتقي الطبيعة الخلابة بالتراث العريق</h3>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              ...
              <div key={i} className={`bg-[#0b1619]/90 backdrop-blur-xl border rounded-[1.5rem] sm:rounded-[2rem] p-4 sm:p-6 flex flex-col items-center text-center transition-transform hover:-translate-y-2 cursor-pointer ${srv.active ? 'border-amber-500/50 shadow-[0_0_30px_rgba(245,158,11,0.15)]' : 'border-white/10'} ${i === 4 ? 'col-span-2 sm:col-span-1' : ''}`}>
                <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center mb-3 sm:mb-4 border ${srv.active ? 'bg-amber-500/20 text-amber-400 border-amber-500/30' : 'bg-white/5 text-gray-400 border-white/10'}`}>
