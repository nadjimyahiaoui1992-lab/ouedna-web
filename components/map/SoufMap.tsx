    ...
    <div dir="rtl" className="relative w-full h-[100dvh] flex flex-col bg-[#0b1220] text-white overflow-hidden">
      ...
      <div className="relative flex-1 min-h-0">
        ...
        {routeTarget && (
          <div
            dir="rtl"
            className="fixed inset-x-0 bottom-0 z-[950] max-h-[75vh] overflow-y-auto rounded-t-3xl
                       md:absolute md:inset-x-auto md:bottom-auto md:top-4 md:right-4 md:w-[380px] md:max-h-[calc(100%-2rem)] md:rounded-2xl
